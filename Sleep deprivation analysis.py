...
##############################################
##############################################
name_score = 'PG EEG scores.csv' ##user scored epochs
sleep_dep_name = 'PGcaspSD.csv' ##sleep deprivation epochs
...
global_name = '_PG caspase SD' ## attaches this name to the end of every file
